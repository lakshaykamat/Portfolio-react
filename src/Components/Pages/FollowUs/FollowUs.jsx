    ...
    <div className="py-20 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Stay Connected</p>
          <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">Follow us on social media to stay up-to-date with our latest news and announcements.</p>
        </div>
        <div className="mt-12">
